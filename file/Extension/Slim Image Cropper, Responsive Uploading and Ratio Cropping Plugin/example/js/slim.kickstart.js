...
! function(t, e) {
    ...
    if (t)
        if (t.Slim = function() {
                ...
                function i(t, e, i, n) {
                    if (!(e >= 1)) {
                        for (var o = Math.max(n.width, Math.min(i.width, Math.round(t.width * e))), a = Math.max(n.height, Math.min(i.height, Math.round(t.height * e))), r = t.width, s = t.height, h = t, u = void 0, l = void 0; r > o && s > a;) u = document.createElement("canvas"), r = Math.round(.5 * h.width), s = Math.round(.5 * h.height), r < o && (r = o), s < a && (s = a), u.width = r, u.height = s, l = u.getContext("2d"), l.drawImage(h, 0, 0, r, s), h = st(u);
                        t.width = o, t.height = a, l = t.getContext("2d"), l.drawImage(h, 0, 0, o, a)
                    }
                }! function() {
                    function t(t, i) {
                        i = i || {
                ...
                var u = function() {
                    ...
                    l = function() {
                        ...
                        function i(t, e, i, r, s, h) {
                            var u, l, p, c, d, f, _, m, g, v, y, w, b, k, x, S, C, E, T, P, M, I, R, L, O = t.data,
                                D = h + h + 1,
                                z = r - 1,
                                A = s - 1,
                                H = h + 1,
                            ...
                            var q = o[h],
                                V = a[h];
                            for (l = 0; l < s; l++) {
                                for (S = C = E = T = m = g = v = y = 0, w = H * (P = O[f]), b = H * (M = O[f + 1]), k = H * (I = O[f + 2]), x = H * (R = O[f + 3]), m += U * P, g += U * M, v += U * I, y += U * R, B = N, p = 0; p < H; p++) B.r = P, B.g = M, B.b = I, B.a = R, B = B.next;
                                for (p = 1; p < H; p++) c = f + ((z < p ? z : p) << 2), m += (B.r = P = O[c]) * (L = H - p), g += (B.g = M = O[c + 1]) * L, v += (B.b = I = O[c + 2]) * L, y += (B.a = R = O[c + 3]) * L, S += P, C += M, E += I, T += R, B = B.next;
                                for (W = N, j = F, u = 0; u < r; u++) O[f + 3] = R = y * q >> V, 0 != R ? (R = 255 / R, O[f] = (m * q >> V) * R, O[f + 1] = (g * q >> V) * R, O[f + 2] = (v * q >> V) * R) : O[f] = O[f + 1] = O[f + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = _ + ((c = u + h + 1) < z ? c : z) << 2, S += W.r = O[c], C += W.g = O[c + 1], E += W.b = O[c + 2], T += W.a = O[c + 3], m += S, g += C, v += E, y += T, W = W.next, w += P = j.r, b += M = j.g, k += I = j.b, x += R = j.a, S -= P, C -= M, E -= I, T -= R, j = j.next, f += 4;
                                _ += r
                            }
                            for (u = 0; u < r; u++) {
                                for (C = E = T = S = g = v = y = m = 0, f = u << 2, w = H * (P = O[f]), b = H * (M = O[f + 1]), k = H * (I = O[f + 2]), x = H * (R = O[f + 3]), m += U * P, g += U * M, v += U * I, y += U * R, B = N, p = 0; p < H; p++) B.r = P, B.g = M, B.b = I, B.a = R, B = B.next;
                                for (d = r, p = 1; p <= h; p++) f = d + u << 2, m += (B.r = P = O[f]) * (L = H - p), g += (B.g = M = O[f + 1]) * L, v += (B.b = I = O[f + 2]) * L, y += (B.a = R = O[f + 3]) * L, S += P, C += M, E += I, T += R, B = B.next, p < A && (d += r);
                                for (f = u, W = N, j = F, l = 0; l < s; l++) c = f << 2, O[c + 3] = R = y * q >> V, R > 0 ? (R = 255 / R, O[c] = (m * q >> V) * R, O[c + 1] = (g * q >> V) * R, O[c + 2] = (v * q >> V) * R) : O[c] = O[c + 1] = O[c + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = u + ((c = l + H) < A ? c : A) * r << 2, m += S += W.r = O[c], g += C += W.g = O[c + 1], v += E += W.b = O[c + 2], y += T += W.a = O[c + 3], W = W.next, w += P = j.r, b += M = j.g, k += I = j.b, x += R = j.a, S -= P, C -= M, E -= I, T -= R, j = j.next, f += r
                            }
                            return t
                        }
                ...
                var p = function() {
                    ...
                    Y = function(t, e, i, n) {
                        t = "" + t + (t.indexOf("?") !== -1 ? "&" : "?") + "url=" + e;
                        var o = new XMLHttpRequest;
                        o.open("GET", t, !0), o.responseType = "json", o.onload = function() {
                            return "failure" === this.response.status ? void i(this.response.message) : void J(this.response.body, n)
                        }, o.send()
                    },
                    J = function(t, e) {
                    ...
                    et = function(t) {
                        ...
                        if (s) {
                            ...
                            s.x < 0 && (s.x = 0),
                                s.y < 0 && (s.y = 0), s.width > c.width && (s.width = c.width), s.height > c.height && (s.height = c.height), s.y + s.height > c.height && (s.y = Math.max(0, c.height - s.height)), s.x + s.width > c.width && (s.x = Math.max(0, c.width - s.width));
                            var d = s.x / c.width,
                                f = s.y / c.height,
                                _ = s.width / c.width,
                                m = s.height / c.height;
                        ...
                        return p(i, [{
                            ...
                            value: function(t, e, i) {
                                ...
                                if (!this._isBeingDestroyed) {
                                    ...
                                    if ("string" == typeof t) return void(X(t) ? this._load(Z(t), e, i) : (o(), J(t, function(t) {
                                        n._load(t, e, i)
                                    })));
                                    if ("undefined" != typeof t.remote && this._options.fetcher) return void Y(this._options.fetcher, t.remote, function(t) {
                                        a(), n._onRemoteURLProblem("<p>" + t + "</p>"), e && e.apply(n, ["remote-url-problem"])
                                    }, function(t) {
                                        n._load(t, e, i)
                                    });
                                    var r = t;
                                    if (this._imageHopper && this._imageHopper.accept.indexOf(r.type) === -1) return a(), this._onInvalidFile(), void(e && e.apply(this, ["file-invalid"]));
                                    if (r.size && this._options.maxFileSize && z(r.size) > this._options.maxFileSize) return a(), this._onOverWeightFile(), void(e && e.apply(this, ["file-too-big"]));
                                    this._imageEditor && this._imageEditor.dirty(), this._data.input.name = i && i.name ? i.name : j(r), this._data.input.type = q(r), this._data.input.size = r.size, this._data.input.file = r, Q(r, this._options.internalCanvasSize, function(t, i) {
                                        var o = function() {
                                        ...
                                        if (!t) return o(), void(e && e.apply(n, ["file-not-found"]));
                                        if (!ct(t, n._options.minSize)) return o(), n._onImageTooSmall(), void(e && e.apply(n, ["image-too-small"]));
                                        var a = n._options.didLoad.apply(n, [r, t, i, n]);
                                        if (a !== !0) return o(), a !== !1 && n._throwError(a), void(e && e.apply(n, [a]));
                                        ...
                                        n._loadCanvas(t, function(t) {
                                            n._addState("preview"), s(function() {
                                                n._canInstantEdit() || t || n._showButtons(), t || (n._stopProgressLoop(), n._removeState("busy")), e && e.apply(n, [null, n.data])
                                            })
                                        }, function() {
                            ...
                            value: function(t, e) {
                                ...
                                n.filters = {
                                ...
                                }, n.minSize = this._options.minSize, et(t, n, function(t) {
                                    var n = t;
                                    ...
                                    if (i._options.size && i._options.minSize.width === i._options.size.width && i._options.minSize.height === i._options.size.height && (n.width < i._options.minSize.width || n.height < i._options.minSize.height)) {
                            ...
                            value: function(t, e) {
                                var i = this,
                                    o = function(o) {
                                        var a = new FormData;
                                        if (null !== i._data.output.image && i._options.uploadBase64 === !1) {
                                            var r = Z(t.output.image, t.output.name);
                                            if (o.imageHead && i._options.copyImageHead) try {
                                                r = new Blob([o.imageHead, n.blobSlice.call(r, 20)], {
                                                    type: wt(t.output.image)
                                                }), r = G(r, t.output.name)
                                            } catch (s) {}
                                            var h = "slim_output_" + i._uid;
                                            t.output.image = null, t.output.field = h, a.append(h, r, t.output.name)
                                        }
                                        a.append(i._output.name, JSON.stringify(t)), L("input", i._options.post) && a.append(i._inputReference, i._data.input.file, i._data.input.file.name);
                                        var u = i._element.querySelector(".slim-upload-status"),
                                            l = i._options.willRequest,
                                            p = function(t, e) {
                                            ...
                                            c = function(t) {
                                                var n = setTimeout(function() {
                                                    if (!i._isBeingDestroyed) {
                                                        u.innerHTML = i._options.statusUploadSuccess, u.setAttribute("data-state", "success"), u.style.opacity = 1;
                                                        var t = setTimeout(function() {
                                                            u.style.opacity = 0
                                                        }, 2e3);
                                                        i._timers.push(t)
                                            ...
                                            d = function(t) {
                                                ...
                                                var o = setTimeout(function() {
                                                    u.innerHTML = n, u.setAttribute("data-state", "error"), u.style.opacity = 1
                                                }, 250);
                                                i._timers.push(o), e(t)
                                            };
                                        "string" == typeof i._options.service ? O(i._options.service, a, l, p, c, d) : "function" == typeof i._options.service && i._options.service.apply(i, [a, p, c, d])
                                    };
                                n.parseMetaData(this._data.input.file, o, {
                            ...
                            value: function() {
                                ...
                                return Bt.concat(Rt.Buttons).concat("rotate").forEach(function(e) {
                                    var i = M(e);
                ...
                return function() {
                    ...
                    Bt.concat(Rt.Buttons).concat("rotate").forEach(function(t) {
                        var e = M(t);
