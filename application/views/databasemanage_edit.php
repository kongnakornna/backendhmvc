...
<?php
		...
		echo form_open('tmon/databasemanage/save', $attributes);
?>
...
<?php
			if(function_exists('Debug')){
					//Debug($databasemanage);
			}
					//Debug($databasemanage);Die();
					$countitem = count($databasemanage);
					//echo'$countitem='.$countitem;Die();
					$condition_group_id2=$databasemanage[0]['condition_group_id2'];
  					$condition_group_name_en=$databasemanage[0]['condition_group_name'];
                    $condition_group_name_th=$databasemanage[1]['condition_group_name'];
                    $hour_start=$databasemanage[0]['hour_start'];
                    $minute_start=$databasemanage[0]['minute_start'];
                    $hour_finish=$databasemanage[0]['hour_finish'];
                    $minute_finish=$databasemanage[0]['minute_finish'];
                    $day_start=$databasemanage[0]['day_start'];
                    $day_finish=$databasemanage[0]['day_finish'];
                    $date_start=$databasemanage[0]['date_start'];
                    $date_finish=$databasemanage[0]['date_finish'];
                    $month_start=$databasemanage[0]['month_start'];
                    $month_finish=$databasemanage[0]['month_finish'];
                    $Sun=$databasemanage[0]['Sun'];
					$Mon=$databasemanage[0]['Mon'];
					$Tue=$databasemanage[0]['Tue'];
					$Wed=$databasemanage[0]['Wed'];
					$Thu=$databasemanage[0]['Thu'];
					$Fri=$databasemanage[0]['Fri'];
					$Sat=$databasemanage[0]['Sat'];
					$status=$databasemanage[0]['status'];
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="condition_group_name_th" type="text" class="col-xs-10 col-sm-5" id="condition_group_name_th" value="<?php echo $condition_group_name_th;?>" placeholder="<?php echo $language['title']?> <?php echo $language['databasemanage'] ?> (TH)"> 
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['databasemanage'] ?> (EN)" id="condition_group_name_en" name="condition_group_name_en" value="<?php echo $condition_group_name_en;?>"> 
											 <?php  //echo 'databasemanage Control Auto works';//echo $language['hwcontrols']; ?>
										</div>
									</div>
