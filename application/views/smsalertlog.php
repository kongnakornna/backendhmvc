...
<?php
	...
	echo form_open('tmon/smsalertlog', $attributes);
?>
...
<?php
				...
				for($key=0;$key<$maxcat;$key++){
							$sms_id = $smsalertlog_list[$key]['sms_id'];
							$sensor_name = $smsalertlog_list[$key]['sensor_name'];
							$value = $smsalertlog_list[$key]['value'];
							$status = $smsalertlog_list[$key]['status'];
							$to = $smsalertlog_list[$key]['to'];
							$date = $smsalertlog_list[$key]['date'];
						 
?>
		<tr>
						<td><a href="#"><?=$sms_id?></a></td>
						<td><?php echo $i;?></td>
						<td><a href="#"><?=$smsalertlog_list[$key]['sensor_name']?></a></td>
						<td><a href="#"><?=$smsalertlog_list[$key]['value']?></a></td>
						<td><a href="#"><?=$smsalertlog_list[$key]['status']?></a></td>
						<td>
						<a href="#">
						<?php if($to<>''){echo $to;}?> </a></td>
						<td><a href="#"><?php $create_date=$smsalertlog_list[$key]['date'];
