...
<?php
		...
		echo form_open('tmon/waterpipe/save', $attributes);
?>
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['waterpipe'] ?> (TH)" id="waterpipe_name_th" name="waterpipe_name_th">   
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['waterpipe'] ?> (EN)" id="waterpipe_name_en" name="waterpipe_name_en" value="">    
										</div>
									</div>
...
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-3 col-sm-3" placeholder="<?php echo $language['size'] ?> " id="size" name="size" value=""> 
