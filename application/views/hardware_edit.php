...
<?php
		...
		echo form_open('tmon/hardware/save', $attributes);
?>
...
<div class="col-sm-9"><input name="value" type="text" class="col-xs-8 col-sm-4" id="value"  value="<?php echo $value;?>" placeholder="<?php echo $language['value']?>">
</div>
</div>
<!-- ################################## -->		
<div class="form-group">
