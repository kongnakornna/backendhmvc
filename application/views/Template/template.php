...
}else if($this->uri->segment(2)=='workflow'|| $this->uri->segment(2)=='floorplan'|| $this->uri->segment(2)=='control'|| $this->uri->segment(2)=='locationmonitor'){ 
...
}else if($this->uri->segment(2)=='workflow'|| $this->uri->segment(2)=='control'|| $this->uri->segment(2)=='locationmonitor'){ 

$this->load->view('template/footer-smart');

}else if($this->uri->segment(2)=='floorplan'){ 
$this->load->view('template/footer-smart');
}else{ 
