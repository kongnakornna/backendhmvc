...
<style type="text/css">
.custom-date-style {
	background-color: red !imcurrent_idant;
}
</style>
<?php 
...
<div class="col-xs-12"> 
								<!-- PAGE CONTENT BEGINS -->
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('tmon/electricitytype') ?>';">
								<i class="clip-cog-2"></i> <?php echo $language['electricitytype'] ?> 
								</button>
								
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('tmon/waterpipe') ?>';">
								<i class="clip-cog-2"></i> <?php echo $language['waterpipe'] ?> 
								</button>
								
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('tmon/hardwaretest/add') ?>';">
								<i class="clip-cog-2"></i><?php echo $language['add'] ?> <?php echo ' '; ?><?php echo $language['hardwaretest'] ?> 
								</button>
...
<div>
	...
	<thead>
		<tr>
														...
														<th width="2%"><i class="ace-icon fa fa-sort-numeric-desc bigger-110 hidden-480"></i>
														<?php //echo $language['no'] ?></th>
														<th width="24%"><i class="ace-icon fa fa-sort-amount-desc bigger-110 hidden-480"></i>
														<?php echo $language['title'] ?><?php #echo $language['hardwaretest'] ?></th>
														<th width="13%"><?php echo $language['electricitytype'] ?></th>
														<th width="12%"><?php echo $language['waterpipe'] ?></th>
														<!--
														<th width="8%">Pump</th>
														<th width="8%">Flow</th>
														<th width="12%">Courrent</th>
														<th width="9%">Voltage</th>
														<th width="7%">Power</th>
														-->
														<th width="16%"><i class="ace-icon fa fa-sitemap bigger-110 hidden-480"></i>
														<?php echo $language['access'] ?>  </th>
														<th width="20%">
														<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
														<?php  echo $language['create_date'] ?></th>
														<!--
														<th width="11%"><i class="ace-icon fa fa-eye bigger-110 hidden-480"></i>
														<?php //echo $language['status'] ?></th>
														-->
														<th width="10%"><i class="ace-icon fa fa-tint bigger-110 hidden-480"></i><?php echo $language['action'] ?></th>
					</tr>
				  </thead>
				<tbody>
<?php
				...
				for($key=0;$key<$maxcount;$key++){
					...
					$electricity_type_name=$hardware_list[$key]['electricity_type_name'];
					$waterpipe_name=$hardware_list[$key]['waterpipe_name'];
					#################3
...
?>
		<tr>
						...
						<?php echo $hardwaretest_id_map;?><input type="hidden" class="ace" name="selectid[]" value="<?php echo $hardwaretest_id_map;?>"/>
						</span>						</td>
						<td><?=$i?> </td>
						<td>
						<!-- <i class="fa fa-desktop "></i>-->
						<?php echo $hardwaretest_name; ?></td>
						<td><?php echo $electricity_type_name; ?></td>
						<td><?php echo $waterpipe_name; ?></td>
						<!--
						<td><?php echo $pump_name;?></td>
						<td><?php echo $flow_name;?></td>
						<td><?php echo $current_name;?></td>
						<td><?php echo $voltage_name;?></td>
						<td><?php echo $power_name;?></td>
						-->
						<td>

 
<a href="<?php echo site_url('tmon/hardwaretest/hardwaretest_run/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
<?php  $test=$language['test']; echo "<font color='Green'> $test </font>  "; ?></a>
|<a href="<?php echo site_url('tmon/hardwaretest/hardwaretest_log/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
<?php  $view=$language['view'];  echo "<font color='Green'> $view </font>  "; ?>	
</a>
|<a href="<?php echo site_url('tmon/hardwaretest/hardwaretest_chart/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
<?php  $interactivechart=$language['interactivechart'];  echo "<font color='Green'> $interactivechart </font>  "; ?>	
</a>
</td>
 <td>
<?php  
...
$create_date=RenDateTime($create_date); 
 echo "<font color='blue'> $create_date </font>";
 }else{ echo "<font color='red'> $create_date </font>";  
 }
?>
</td>
<!--
						<td>
								<label> 
										<input name="status[]" id="status<? //=$hardware_list[$key]['hardwaretest_id_map']?>" class="ace ace-switch ace-switch-5 btn-empty" type="checkbox" <?php// if($status== 1){echo 'checked'; }?>  value=1>
										<span class="lbl"></span>
										</label>
										</td>
-->
													...
													<div class="btn-group">
														...
														<?php if($hardware_list[$key]['status'] == 1 || $hardware_list[$key]['status'] == 0){?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('tmon/hardwaretest/edit/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
																	<i class="fa fa-edit"></i> <?php $edit=$language['edit']; echo "<b><font color='blue'> $edit </font></b>";?>
																</a>															</li>
															<?php }?>
														 <?php if($hardware_list[$key]['hardwaretest_id_map'] > 1){?>
														  
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="#"id="bx-confirm<?=$hardware_list[$key]['hardwaretest_id_map']?>" class="tooltip-error" data-rel="tooltip" title="Delete">
...
<?php
		if($hardware_list)		
				for($key=0;$key<$maxcount;$key++){		
						$title = $hardwaretest_name;
?>
		$('#status<?=$hardware_list[$key]['hardwaretest_id_map']?>').on('click', function() {
				var id = $(this).attr('id');
		    	var n = id.length;
			    var maxstr = n-6;
				...
				$.ajax({
					type: 'POST',
					url:  '<?php echo base_url('hardwaretest/status/'.$hardware_list[$key]['hardwaretest_id_map'])?>',
					cache: false,
		...
		$('#bootbox-confirm<?=$hardware_list[$key]['hardwaretest_id_map']?>').on('click', function() {
					bootbox.confirm("<?php echo $language['are you sure to delete']?>", function(result) {
						if(result) {
								window.location='<?php echo base_url('hardwaretest/delete/'.$hardware_list[$key]['hardwaretest_id_map'])?>';
						}
					});
		});

		$('#bx-confirm<?=$hardware_list[$key]['hardwaretest_id_map']?>').on('click', function() {
					bootbox.confirm("<?php echo $language['are you sure to delete']?>", function(result) {
						if(result) {
								window.location='<?php echo base_url('hardwaretest/delete/'.$hardware_list[$key]['hardwaretest_id_map'])?>';
						}
