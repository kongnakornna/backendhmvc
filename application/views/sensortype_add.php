...
<?php
		...
		echo form_open('tmon/sensortype/save', $attributes);
?>
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['sensortype'] ?> (TH)" id="sensor_type_name_th" name="sensor_type_name_th">   
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['sensortype'] ?> (EN)" id="sensor_type_name_en" name="sensor_type_name_en" value="">    
										</div>
									</div>
