...
<?php
	...
	echo form_open('tmon/hardwarealert', $attributes);
?>
													...
													<div class="btn-group">
														...
														<?php if($hardware_list[$key]['status'] == 1 || $hardware_list[$key]['status'] == 0){?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('tmon/hardwarealert/edit/'.$hardware_list[$key]['hardware_id_map']); ?>">
