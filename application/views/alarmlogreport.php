...
<?php
	...
	echo form_open('tmon/alarmlogreport', $attributes);
?>
...
<div>
    ...
    <thead>
      <tr>
        <th width="40">ID</th>
        <th width="32"><?php echo $language['no'] ?>.</th>
        <th width="141"><?php echo $language['hardware'] ?></th>
        <th width="171"><?php echo $language['sensor'] ?></th>
        <th width="155" class="hidden-480"><?php echo $language['sensortype'] ?> </th>
        <th width="136"> <?php echo $language['sensorvalue'] ?> </th>
        <th width="128"> <?php echo $language['statuswarning'] ?> </th>
        <th width="167"> <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i><?php echo $language['datetime'] ?> </th>
      </tr>
    </thead>
    <tbody>
<?php
				...
				for($key=0;$key<$maxcat;$key++){
							...
							$sensor_type = $web_menu[$key]['sensor_type'];
							$sensor_value = $web_menu[$key]['sensor_value'];
							$alert_status = $web_menu[$key]['alert_status'];
							$datetime_alert = $web_menu[$key]['datetime_alert'];
?>
      <tr>
		<td> <span class="label label-info"> <?php  echo number_format($sensor_alert_log_id, 0 , '.'    , ','   );?></span> </td>
        <td> <?php echo $i;?>  </td>
        <td><a href="#">
          <?=$web_menu[$key]['sensor_hwname']?>
        </a></td>
        <td><a href="#">
          <?=$web_menu[$key]['sensor_name']?>
        </a></td>
        <td><a href="#">
          <?=$web_menu[$key]['sensor_type']?>
        </a></td>
        <td><a href="#">
          <?php 
						$sensor_value=$web_menu[$key]['sensor_value'];
						...
						echo "<b><font color='red'> $sensor_value</font></b>";
						}else if($alert_status=='Warning'){
						//echo "<b><font color='yellow'> $alert_status </font></b>";
						echo "<b><font color='Orange'> $sensor_value </font></b>";
						}else if($alert_status=='Normal'){
						echo "<b><font color='green'> $alert_status </font></b>";
						}else if($sensor_value=='0' || $sensor_value=='-127' || $sensor_value=='' ){
						echo "<b><font color='red'> $sensor_value </font></b>";
        ...
        <td><a href="#">
          <?php 
						...
						//echo "<b><font color='yellow'> $alert_status </font></b>";
						echo "<b><font color='Orange'> $alert_status </font></b>";
						}else if($alert_status=='Normal'){
						echo "<b><font color='green'> $alert_status </font></b>";
						}else if($sensor_value=='0' || $sensor_value=='-127' || $sensor_value=='' ){

						echo "<b><font color='red'> $erroralert</font></b>";
						}else{echo $alert_status;}
						?>
        </a> </td>
        <td><a href="#">
          <?php $create_date=$web_menu[$key]['datetime_alert'];
