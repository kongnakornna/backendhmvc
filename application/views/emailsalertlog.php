...
<?php
	...
	echo form_open('tmon/emailalertlog', $attributes);
?>
...
<div>
	<table>-->
												<thead>
														<tr><th width="39"><?php echo $language['no'] ?>.</th>
														<th width="51">ID</th>
...
?>
		...
		<tr>
						...
						<td><a href="#"><?php echo $sensor_name;?></a></td>
						<td><a href="#"><?php echo $value;?></a></td>
						<td><a href="#"><?php echo $status; ?></a></td>
						<td>
						<?php if($to<>''){echo $to;}?> 
						</td>
						<td> 
      <?php $create_date=$date;
