...
<?php
		...
		echo form_open('tmon/electricitytype/save', $attributes);
?>
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['electricitytype'] ?> (TH)" id="electricity_type_name_th" name="electricity_type_name_th">   
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['electricitytype'] ?> (EN)" id="electricity_type_name_en" name="electricity_type_name_en" value="">    
										</div>
									</div>
<?php ############?>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text" class="col-xs-2 col-sm-2" placeholder="<?php echo $language['value']?>" id="value" name="value" value=""> 	  
										</div>
									</div>
									<?php ############?>
<div class="form-group">
