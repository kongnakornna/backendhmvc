...
<?php 
		...
		$i=0;
		$maxcat = count($sensorreport_list);
		$lang=$language['lang']; 
if($startdate==''){
...
<div class="col-xs-12"> 
								<!-- PAGE CONTENT BEGINS -->
  <i class="clip-cog-2"></i> <?php echo $language['sensorreport'] ?> 
...
<?php
	...
	echo form_open('tmon/sensorreport', $attributes);
?>
...
<?php
				...
				if($sensorreport_list)
				for($key=0;$key<$maxcat;$key++){
				$sensor_log_id=$sensorreport_list[$key]['sensor_log_id'];
				$sensor_log_id2=$sensorreport_list[$key]['sensor_log_id'];
				$sensor_hwname=$sensorreport_list[$key]['sensor_hwname'];
				$sensor_name=$sensorreport_list[$key]['sensor_name'];
				$sensor_type=$sensorreport_list[$key]['sensor_type'];
				$sensor_value=$sensorreport_list[$key]['sensor_value'];
				$datetime_log=$sensorreport_list[$key]['datetime_log'];
?>
		<tr>
						<td> <span class="label label-info"> <?php echo number_format($sensor_log_id, 0 , '.'    , ','   );?></span> </td>
						<td> <?php echo $i;?>   </td>
						<td><?php echo "<font color='Red'> $sensor_hwname </font>";  ?></td>
						<td><?php echo "<font color='Green'> $sensor_type </font>";  ?></td>
						<td><?php echo "<font color='Blue'> $sensor_value </font>";  ?></td>
					    <td><?php  
						if($lang=='th'){
						$datetime_log=RenDateTime($datetime_log);  
						echo "<font color='Blue'> $datetime_log </font>";  }else{ echo "<font color='Blue'> $datetime_log </font>";  } ?>
						</td>                    
		</tr>
