...
<?php
		...
		echo form_open('tmon/carebase/save', $attributes);
?>
...
<div class="col-sm-9"><input name="carebase_name_en" type="text" class="col-xs-10 col-sm-5" id="carebase_name_en" placeholder="<?php echo $language['name']?>">
</div>
</div>
...
<label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['carebase']?><?php echo $language['name']?> EN </label>
<div class="col-sm-9">
<input name="carebase_name_th" type="text" class="col-xs-8 col-sm-5" id="carebase_name_th" placeholder="<?php echo $language['name']?> ">
</div>
</div>
...
<div class="col-sm-9">
<input name="carebase_value" type="text" class="col-xs-2 col-sm-1" id="carebase_value" placeholder="<?php echo $language['value']?> ">
</div>
</div>
...
<div class="col-sm-9">
<input name="carebase_type" type="text" class="col-xs-1 col-sm-1" id="carebase_type" value="-" placeholder="<?php echo $language['type']?> ">
</div>
</div>
