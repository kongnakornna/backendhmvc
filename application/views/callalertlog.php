...
<?php 
		...
		$i=0;
		$maxcat = count($callalertlog_list);
		$lang=$language['lang']; 
if($startdate==''){
...
<?php
	...
	echo form_open('tmon/callalertlog', $attributes);
?>
...
<div>
	...
	<thead>
		<tr>
														...
														<th width="4%">ID</th>
														<th width="4%"><i class="ace-icon fa fa-sort-amount-desc bigger-110 hidden-480"></i>
														<?php //echo $language['no'] ?></th>
														<th width="21%"><i class="ace-icon fa fa-sort-amount-desc bigger-110 hidden-480"></i>
														<?php echo $language['sensor_name'] ?></th>
														<th width="8%"><i class="ace-icon fa fa-sitemap bigger-110 hidden-480"></i>
														<?php echo $language['status'] ?>  </th>
														<th width="24%">
														<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
														<?php echo $language['sensorvalue'] ?></th>
					                                    <th width="17%"><?php echo $language['mobile'] ?></th>
														<th width="22%"><?php echo $language['date'] ?></th>
		</tr>
				  </thead>
				<tbody>
<?php
				...
				$i=1;
				if($callalertlog_list)
				for($key=0;$key<$maxcat;$key++){
							$call_id = $callalertlog_list[$key]['call_id'];
							$sensor_name = $callalertlog_list[$key]['sensor_name'];
							$value = $callalertlog_list[$key]['value'];
							$status = $callalertlog_list[$key]['status'];
							$to = $callalertlog_list[$key]['to'];
							$date = $callalertlog_list[$key]['date'];
						 
?>
		<tr>
						<td><a href="#"><?=$call_id?></a></td>
						<td><?php echo $i;?></td>
						<td><a href="#"><?=$callalertlog_list[$key]['sensor_name']?></a></td>
						<td><a href="#"><?=$callalertlog_list[$key]['value']?></a></td>
						<td><a href="#"><?=$callalertlog_list[$key]['status']?></a></td>
						<td>
						<a href="#">
						<?php if($to<>''){echo $to;}?> </a></td>
						<td><a href="#"><?php $create_date=$callalertlog_list[$key]['date'];
