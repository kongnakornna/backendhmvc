...
<?php
		...
		echo form_open('tmon/hardwaretest/save', $attributes);
?>
<body onLoad="init()">
...
<!-- PAGE CONTENT BEGINS -->						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<button class="btn btn-sm btn-primary" onClick="window.location='<?php echo site_url('tmon/hardwaretest/pcurve') ?>';">
								<i class="clip-cog-2"></i> P-curve
								</button>
								
								<button class="btn btn-sm btn-primary" onClick="window.location='<?php echo site_url('tmon/hardwaretest/ecurve') ?>';">
								<i class="clip-cog-2"></i>  E-curve
								</button>

								<button class="btn btn-sm btn-primary" onClick="window.location='<?php echo site_url('tmon/hardwaretest/data') ?>';">
...
<div>
 ...
 <!-- ################################## -->
            <div class="form-group">
              ...
              <div class="col-sm-9">
               <input name="hardwaretest_name" type="text" class="col-xs-10 col-sm-10" id="hardwaretest_name" placeholder="<?php echo $language['name']?>"/>
              </div>
            </div>
            <!-- ################################## -->
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9"> <?php //echo $ListSelecthw_pump_id;?> <canvas id="canvasSingle1" width="120" height="50"></canvas> <b>m.</b></div>
            </div>
            <!-- ################################## -->
            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['flow']?> </label>
              <div class="col-sm-9"> <?php //echo $ListSelectflow_id;?> <canvas id="canvasSingle2" width="120" height="50"></canvas> <b>gmp.</b></div>
            </div>
            <!-- ################################## -->
            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['pressure']?> </label>
              <div class="col-sm-9"> <?php //echo $ListSelectpower_id;?> <canvas id="canvasSingle6" width="120" height="50"></canvas> <b>P</b></div>
            </div>
            <!-- ################################## -->
            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['current']?> </label>
              <div class="col-sm-9"> <?php //echo $ListSelectcurrent_id;?> <canvas id="canvasSingle3" width="120" height="50"></canvas> <b>A</b></div>
            </div>
            <!-- ################################## -->
            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['voltage']?> </label>
              <div class="col-sm-9"> <?php //echo $ListSelectvoltage_id;?><canvas id="canvasSingle4" width="120" height="50"></canvas> <b>V</b></div>
            </div>
            <!-- ################################## -->
            <div class="form-group">
              <label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['power']?> </label>
              <div class="col-sm-9"> <?php //echo $ListSelectpower_id;?> <canvas id="canvasSingle5" width="120" height="50"></canvas> <b>W</b></div>
            </div>
...
////////////////1
        ...
        // Start the random update
  			setInterval(function(){ setRandomValue1(single1, <?php echo $singlemax1;?>); }, 1000);
///////////////2
        ...
        // Start the random update
  			setInterval(function(){ setRandomValue2(single2, <?php echo $singlemax2;?>); }, 1000);
///////////////2
        ...
        // Start the random update
  			setInterval(function(){ setRandomValue3(single3, <?php echo $singlemax3;?>); }, 1000);
///////////////2
        ...
        // Start the random update
  			setInterval(function(){ setRandomValue5(single4, <?php echo $singlemax4;?>); }, 1000);
///////////////5
        ...
        // Start the random update
  			setInterval(function(){ setRandomValue5(single5, <?php echo $singlemax5;?>); }, 1000);
...
///////////////6
        ...
        // Start the random update
  			setInterval(function(){ setRandomValue6(single6, <?php echo $singlemax6;?>); }, 1000);
