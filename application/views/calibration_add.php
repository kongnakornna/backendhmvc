...
<?php
		...
		echo form_open('tmon/calibration/save', $attributes);
?>
...
<div class="col-sm-9"><input name="calibration_name_en" type="text" class="col-xs-10 col-sm-5" id="calibration_name_en" placeholder="<?php echo $language['name']?>">
</div>
</div>
...
<div class="col-sm-9">
<input name="calibration_name_th" type="text" class="col-xs-8 col-sm-5" id="calibration_name_th" placeholder="<?php echo $language['name']?> ">
</div>
</div>
...
<div class="col-sm-9">
<input name="calibration_value" type="text" class="col-xs-2 col-sm-1" id="calibration_value" placeholder="<?php echo $language['value']?> ">
</div>
</div>
...
<div class="col-sm-9">
<input name="calibration_type" type="text" class="col-xs-1 col-sm-1" id="calibration_type" value="-" placeholder="<?php echo $language['type']?> ">
</div>
</div>
