...
<table class="table table-striped table-bordered table-hover" id="sample-table-2">
	<thead>
			<tr>
				<th width="42">ID</th>
				<th width="54"><?php echo $language['no'] ?></th>
...
?>
		<tr>
						...
						?></a></td>
						<td>											 
							<a href="<?php echo site_url('tmon/sensorconfig/edit/'.$web_menu[$key]['sensor_config_id']); ?>" class="tooltip-success" data-rel="tooltip" title="<?php echo $language['edit']?>">
							<span class="green">
