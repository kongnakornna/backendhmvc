...
<!-- ##########################  -->
<center> <div class="panel-body"style="padding: 1px 5px;">
<?php  echo $pagination;?></div>  </center>
<div>
<?php
	$attributes = array('class' => 'form-horizontal', 'id' => 'jform');
	echo form_open('tmon/activity_logsna', $attributes);
?>
...
<?php ###############?>
							<div class="panel panel-default">
								<div class="panel-heading">
									<i class="clip-cog-2"></i><?php echo $language['activity_logs'] ?>
...
<div class="table-responsive">
	<table width="100%"  class="table table-striped table-hover table-bordered " id="sample-table-2"> 
		<thead>
				<tr>
				<th width="3%"><?php echo $language['no'] ?></th>
				<th width="2%"><?php echo "ID"; ?></th>
				<th width="8%"><?php echo $language['type'] ?></th>
				<th width="8%"><?php echo $language['ipaddress'] ?></th>
				<th width="47%"><?php echo $language['title'] ?></th>
				<th width="17%" class="hidden-480"><?php echo $language['datetime'] ?></th>
				<th width="10%" class="hidden-480">
				<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
				<?php echo $language['username'] ?>				</th>
				 
			    <th width="5%" class="hidden-480"><?php echo 'Lang'; ?></th>
				</tr>
	</thead>
				<tbody>
<?php
				...
				for($key=0;$key<$maxcat;$key++){
					...
					$langlog=$logs_list[$key]['lang'];
					switch($ref_id){
							case 0 : $ref_id = 'Access Basic'; break;
							case 1 : $ref_id = 'Access Level.1'; break;
							case 2 : $ref_id = 'Access Level.2'; break;
							case 3 : $ref_id = 'Access Level.3'; break;
							case 4 : $ref_id = 'Access Level.4'; break;
							case 5 : $ref_id = 'Access Level.5'; break;
							case 6 : $ref_id = 'Access Level..6'; break;
							default : $ref_id = 'Access General'; break;
...
?>
		<tr>
						...
						<td><?=$title?></td>
						<td class="hidden-480">
						<?php if($lang=='th'){echo RenDateTime($create_date);}else{echo  $create_date;}  ?>						</td>
						<td class="hidden-480"><?=$admin_username?></td>
						 
		                <td class="hidden-480"><?=$langlog?></td>
		</tr>
