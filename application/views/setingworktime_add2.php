...
<?php
		...
		echo form_open('tmon/setingworktime/save', $attributes);
?>
									<div class="page-header">
										<h1>
											<a href="<?php echo base_url($this->uri->segment(1)) ?>"><?php echo $language['setingworktime'] ?></a>
											<small>
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['setingworktime'] ?> (TH)" id="condition_group_name_th" name="condition_group_name_th"> : 
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['setingworktime'] ?> (EN)" id="condition_group_name_en" name="condition_group_name_en" value=""> : <?php  echo 'Hardware Control Auto works';//echo $language['hwcontrols']; ?>
										</div>
									</div>
									...
									<div class="form-group">
									  ...
									  <?php /*?>
									  <?php echo $language['start'].$language['day']?> 
									    <select name="day_start">
									      <option value="Sun"selected="selected"><?php echo $language['Sun']?> </option>
									      <option value="Mon"><?php echo $language['Mon']?></option>
									      <option value="Tue"><?php echo $language['Tue']?></option>
									      <option value="Wed"><?php echo $language['Wed']?></option>
									      <option value="Thu"><?php echo $language['Thu']?></option>
									      <option value="Fri"><?php echo $language['Fri']?></option>
									      <option value="Sat"><?php echo $language['Sat']?></option>
                                       </select>
									   
									   <?php echo $language['finish'].$language['day']?> 
									   <select name="day_finish">
									      <option value="Sun"><?php echo $language['Sun']?> </option>
									      <option value="Mon"><?php echo $language['Mon']?></option>
									      <option value="Tue"><?php echo $language['Tue']?></option>
									      <option value="Wed"><?php echo $language['Wed']?></option>
									      <option value="Thu"><?php echo $language['Thu']?></option>
									      <option value="Fri"><?php echo $language['Fri']?></option>
									      <option value="Sat"selected="selected"><?php echo $language['Sat']?></option>
                                       </select>
									  </div>
									  <?php */?>
								...
								<?php ############?>
									...
									<span class="label label-warning arrowed-in arrowed-in-right"><?php echo $language['Sun']?></span>
									<label class="radio-inline"><input name="Sun" type="radio" class="grey" value="1" checked="checked"><?php echo $language['active']?></label>
									<label class="radio-inline"><input type="radio" value="0" name="Sun" class="grey"><?php echo $language['inactive']?></label>
								    </label><br />
									 
                                    <label class="checkbox-inline">
                                    <input name="Mon" type="checkbox" class="square-grey" id="Mon" value="1" checked="checked" />
                                    <?php echo $language['Mon']?></label>
                                    <label class="checkbox-inline">
                                    <input name="Tue" type="checkbox" class="square-red" id="Tue" value="1" checked="checked" />
                                    <?php echo $language['Tue']?></label>
                                    <label class="checkbox-inline">
                                    <input name="Wed" type="checkbox" class="square-green" id="Wed" value="1" checked="checked" />
                                    <?php echo $language['Wed']?></label>
                                    <label class="checkbox-inline">
                                    <input name="Thu" type="checkbox" class="square-teal" id="Thu" value="1" checked="checked" />
                                    <?php echo $language['Thu']?></label>
                                    <label class="checkbox-inline">
                                    <input name="Fri" type="checkbox" class="square-orange" id="Fri" value="1" checked="checked" />
                                    <?php echo $language['Fri']?></label>
                                    <label class="checkbox-inline">
                                    <input name="Sat" type="checkbox" class="square-purple" id="Sat" value="1" checked="checked" />
                                    <?php echo $language['Sat']?></label>
...
?>
		$('#status<?=$admin_team[$key]['admin_team_id']?>').on('click', function() {
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo base_url('setingworktime/status/'.$admin_team[$key]['admin_team_id'])?>",
					cache: false,
		...
		$('#bootbox-confirm<?=$admin_team[$key]['admin_team_id']?>').on('click', function() {
					bootbox.confirm("<?php echo $language['are you sure to delete']?>", function(result) {
						if(result) {
								window.location='<?php echo base_url('setingworktime/delete/'.$admin_team[$key]['admin_team_id'])?>';
						}
					});
		});
