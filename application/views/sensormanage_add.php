...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['sensormanage'] ?> (TH)" id="condition_group_name_th" name="condition_group_name_th">   
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['sensormanage'] ?> (EN)" id="condition_group_name_en" name="condition_group_name_en" value="">   <?php // echo 'sensormanage Control Auto works';//echo $language['hwcontrols']; ?>
										</div>
									</div>
