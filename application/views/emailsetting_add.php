...
<?php
		...
		echo form_open('tmon/emailsetting/save', $attributes);
?>
...
?>
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="email_host" type="text" class="col-xs-10 col-sm-8" id="email_host" value="ssl://" placeholder="<?php echo $language['host']?>"> 
...
<div class="col-sm-9">
<input name="email_port" type="text" class="col-xs-10 col-sm-1" id="email_port" value="465" placeholder="<?php echo $language['port']?>"> 
</div>
</div>
<?php ############?>				
<div class="form-group">
...
<div class="col-sm-9">
<input name="email_username" type="text" class="col-xs-10 col-sm-3" id="email_username" placeholder="<?php echo $language['username']?>"> 
</div>
</div>
<?php ############?>				
<div class="form-group">
...
<div class="col-sm-9">
<input name="email_password" type="text" class="col-xs-10 col-sm-3" id="email_password" placeholder="<?php echo $language['password']?>"> 
</div>
</div>
<?php ############?>								
