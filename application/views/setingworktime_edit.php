...
<?php
			if(function_exists('Debug')){
					//Debug($setingworktime);
			}
					//Debug($setingworktime);Die();
					$countitem = count($setingworktime);
					//echo'$countitem='.$countitem;Die();
					$condition_group_id2=$setingworktime[0]['condition_group_id2'];
  					$condition_group_name_en=$setingworktime[0]['condition_group_name'];
                    $condition_group_name_th=$setingworktime[1]['condition_group_name'];
                    $hour_start=$setingworktime[0]['hour_start'];
                    $minute_start=$setingworktime[0]['minute_start'];
                    $hour_finish=$setingworktime[0]['hour_finish'];
                    $minute_finish=$setingworktime[0]['minute_finish'];
                    $day_start=$setingworktime[0]['day_start'];
                    $day_finish=$setingworktime[0]['day_finish'];
                    $date_start=$setingworktime[0]['date_start'];
                    $date_finish=$setingworktime[0]['date_finish'];
                    $month_start=$setingworktime[0]['month_start'];
                    $month_finish=$setingworktime[0]['month_finish'];
                    $Sun=$setingworktime[0]['Sun'];
					$Mon=$setingworktime[0]['Mon'];
					$Tue=$setingworktime[0]['Tue'];
					$Wed=$setingworktime[0]['Wed'];
					$Thu=$setingworktime[0]['Thu'];
					$Fri=$setingworktime[0]['Fri'];
					$Sat=$setingworktime[0]['Sat'];
					$status=$setingworktime[0]['status'];
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="condition_group_name_th" type="text" class="col-xs-10 col-sm-5" id="condition_group_name_th" value="<?php echo $condition_group_name_th;?>" placeholder="<?php echo $language['title']?> <?php echo $language['setingworktime'] ?> (TH)"> 
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['title']?> <?php echo $language['setingworktime'] ?> (EN)" id="condition_group_name_en" name="condition_group_name_en" value="<?php echo $condition_group_name_en;?>"> 
