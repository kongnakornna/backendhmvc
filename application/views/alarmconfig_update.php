...
<?php
		...
		echo form_open('tmon/alarmconfig/save', $attributes);
?>
									<div class="page-header">
										<h3>&nbsp;&nbsp;&nbsp;
											...
											<small>
												...
												<?php echo $language['edit'].' '.$alarmconfig_list[0]['sensor_name'] ?>
											</small>
										</h3>
									</div>
...
//Debug($alarmconfig_list);
  ...
  $sensor_config_id=$alarmconfig_list[0]['sensor_config_id'];
  $sensor_config_id_map=$alarmconfig_list[0]['sensor_config_id_map'];
  $hardware_id=$alarmconfig_list[0]['hardware_id'];
  $sensor_group_en=$alarmconfig_list[0]['sensor_group'];
  $sensor_name_en=$alarmconfig_list[0]['sensor_name'];
  $sensor_type_id=$alarmconfig_list[0]['sensor_type_id'];
  $sensor_high=$alarmconfig_list[0]['sensor_high'];
  $sensor_warning=$alarmconfig_list[0]['sensor_warning'];
  $alert=$alarmconfig_list[0]['alert'];
  $sn=$alarmconfig_list[0]['sn'];
  $model=$alarmconfig_list[0]['model'];
  //$date=$alarmconfig_list[0]['date'];
  $date=date('Y-m-d H:i:s');
  $vendor=$alarmconfig_list[0]['vendor'];
  $status=$alarmconfig_list[0]['status'];
  $sensor_type_name=$alarmconfig_list[0]['sensor_type_name'];
  $status=$alarmconfig_list[0]['status'];
  
  $sensor_group_th=$alarmconfig_list[1]['sensor_group'];
  $sensor_name_th=$alarmconfig_list[1]['sensor_name'];
  
    $lang=$this->lang->line('lang');
	if($lang==='en'){
    $sensor_type_name=$alarmconfig_list[0]['sensor_type_name'];
	}else{
    $sensor_type_name=$alarmconfig_list[1]['sensor_type_name'];
    }
			if(isset($error)){
?>
				<div class="col-xs-12">
