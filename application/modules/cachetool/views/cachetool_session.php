...
<?php ###############?>
							<div class="panel panel-default">
								<div class="panel-heading">
									<i class="clip-cog-2"></i><?php echo 'Session File'; ?>
	...
	function confirmcmsblogfile<?php echo $cmsblog_file_id;?>() {
        swal({
            ...
            setTimeout(function () {
				...
				<?php $confirmcmsblogfile=base_url().'cachetool/delete_cache_sessionpath?uri=cachetool/testdriver&file='.$file; ?>
...
?>						 
<a class="btn btn-app btn-success" href="<?php echo $cache_path.'file/session/'.$file;?>"title="<?php  echo $language['detail']; ?> <?php echo $file;?>"target="_blank">
