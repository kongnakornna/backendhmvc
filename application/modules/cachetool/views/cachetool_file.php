	...
	function confirmcmsdeleteall() {
        swal({
            ...
            setTimeout(function () {
				...
				<?php $confirmcmsblogfile=base_url('cachetool/clear_all_cache'); ?>
...
<?php
    ...
    ?>
		...
		<tr>
						<td><?php echo $i; ?></td>
						<td><a href="<?php echo base_url().'cachetool/delete_cache_file?uri=cachetool/testdriver&file='.$file; ?>"></a><?php echo $file;?></td>
						<td class="hidden-480">
...
<?php $cmsblog_file_id=$i; ?>
	function confirmcmsblogfile<?php echo $cmsblog_file_id;?>() {
        swal({
            ...
            setTimeout(function () {
                // Javascript URL redirection 
				<?php $confirmcmsblogfile=base_url().'cachetool/delete_cache_file?uri=cachetool/testdriver&file='.$file; ?>
                window.location.replace("<?php echo $confirmcmsblogfile; ?>");
            }, 50);
        });
    };
</script> 			
 <a href="#"onclick="confirmcmsblogfile<?php echo $cmsblog_file_id;?>()"title="ลบ <?php echo $file;?>">
 <button class="btn btn-app btn-danger btn-sm">
<i class="ace-icon fa fa-trash-o bigger-200"></i>
...
?>						 
<a class="btn btn-app btn-success" href="<?php echo $cache_path.'file/cache/static/'.$file;?>"title="<?php  echo $language['detail']; ?> <?php echo $file;?>"target="_blank">
...
echo '<pre> agent=>'; print_r($agent); echo '</pre>'; 
echo '<pre> platform=>'; print_r($platform); echo '</pre>'; 
