...
<div class="form-group">
				 ...
				 <input name="department" type="department" id="department" value="<?php if($memberlist) echo $memberlist->_department?>" />
...
<textarea name="address" class="ckeditor form-control" cols="100" rows="2" id="address"><?php if($memberlist) echo $memberlist->_address?></textarea>
