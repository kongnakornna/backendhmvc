...
<?php
	...
	echo form_open('userlogs', $attributes);
?>
<?php ###############?>
...
<thead>
		<tr>
				...
				<th width="18%" class="hidden-480"><?php echo $language['datetime'] ?></th>
...
<?php
				...
				for($key=0;$key<$maxcat;$key++){
					...
					switch($ref_id){
							case 0 : $ref_id = 'Super Administrator'; break;
							case 1 : $ref_id = 'Level.1'; break;
							case 2 : $ref_id = 'Administrator'; break;
							case 3 : $ref_id = 'Manager'; break;
							case 4 : $ref_id = 'Supervisor'; break;
							case 5 : $ref_id = 'Employee'; break;
							case 6 : $ref_id = 'Customer'; break;
							default : $ref_id = 'General'; break;
...
?>
		<tr>
						...
						<td><?=$title?></td>
						<td class="hidden-480">
						<?php if($lang=='th'){echo RenDateTime($create_date);}else{echo  $create_date;}  ?>	
						</td>
