															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" name="admin_username" type="text" id="form-field-username" placeholder="<?php echo $language['username'] ?>" value="<?php if($memberlist) echo $memberlist->_admin_username?>" />
																		</div>
																	</div>
																	...
																	<div class="form-group">
																		<label class="col-sm-4 control-label no-padding-right" for="firstname"><?php echo $language['name'] ?></label>

																		<div class="col-sm-8">
																			<input class="input-small" name="admin_name" type="text" id="firstname" placeholder="<?php echo $language['name'] ?>" value="<?php if($memberlist) echo $memberlist->_admin_name?>" />
																			<input class="input-small" name="admin_lastname" type="text" id="lastname" placeholder="<?php echo $language['lastname'] ?>" value="<?php if($memberlist) echo $memberlist->_admin_lastname?>" />
																		</div>
																	</div>
																</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input name="admin_email" type="email" id="email" value="<?php if($memberlist) echo $memberlist->_admin_email?>" readonly />
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<select id="admin_type_id" name="admin_type_id" class="form-control">
																				...
																				<option value="3" <?php if($memberlist) if($memberlist->_admin_type_id == 3) echo 'selected' ?>>Manager</option>
																				<option value="4" <?php if($memberlist) if($memberlist->_admin_type_id == 4) echo 'selected' ?>>Centent News</option>
																				<option value="5" <?php if($memberlist) if($memberlist->_admin_type_id == 5) echo 'selected' ?>>Colume post</option>
																				<option value="6" <?php if($memberlist) if($memberlist->_admin_type_id == 6) echo 'selected' ?>>Trianee</option>
																			</select>
																	</span>
																</div>
															</div>
														...
														<div class="widget-main"> -->
															...
															<div class="row">
																<div class="col-sm-6">
																	...
																	<span class="bigger-110"><!-- Multiple --><?php echo $language['activity'] ?></span>
																</div><!-- /.span -->
															</div>
