...
<html lang="<?php echo $this->lang->line('lang');?>" class="no-js">
	...
	<div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
		...
		<a href="<?php echo base_url('service');?>"target="_blank">
			<img src="<?php echo base_url(); ?>/images/logo.png" width="80%"/>
		</a>
			</div>
			<!-- start: LOGIN BOX -->
		<div class="box-login">
...
<a href="<?=base_url()?>lang/language?lang=thai"><img src="<?=base_url()?>theme/assets/images/lang/th.png" onClick="lanfTrans('th');"  height="25" title="<?php  echo $this->lang->line('thai');?>"></a>
				...
				<!--
				<h2><?php //echo $this->lang->line('titleweb');?><h2>
				-->
...
?>
											<?php echo form_open(base_url'user/validate_credentials', $attributes); ?>
												<fieldset>
