										...
										<div class="tree smart-form">
											<ul>
												<li>
													...
													<ul>
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 1</span>
															<ul>
																<li>
														...
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 2</span>
															<ul>
																<li>
														...
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 3</span>
															<ul>
																<li>
														...
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 4</span>
															<ul>
																<li>
														...
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 5</span>
															<ul>
																<li>
														...
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 6</span>
															<ul>
																<li>
														...
														<li>
															<span><i class="fa fa-lg fa-minus-circle"></i> Sensor 7</span>
															<ul>
																<li>
...
<script type="text/javascript" src="<?php echo base_url('theme');?>/assets/js/justgage.js"></script>
      ...
      var tmonrt_hw1 = '<?php echo base_url();?>/hwdata/json/acms_hw1.json';
      ...
      var tmonrt_hw2 = '<?php echo base_url();?>/hwdata/json/acms_hw2.json';
      ...
      //window.onload = function(){
        ...
        setInterval(function() {
          ...
          $.getJSON(tmonrt_hw1, function (json) { 
 		  ...
 		  $.getJSON(tmonrt_hw2, function (json2) { 
