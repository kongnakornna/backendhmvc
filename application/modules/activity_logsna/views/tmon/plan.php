...
<?php if($admin_type==1){?>
								<!-- PAGE CONTENT BEGINS -->
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('plan/add') ?>';">
...
<?php
	...
	echo form_open('plan', $attributes);
?>
													...
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('plan/edit/'.$plan_list[$key]['plan_id_map']); ?>">
