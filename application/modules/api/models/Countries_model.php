...
public function count_countries($countries_id=null, $search_string=null, $order=null){
		$this->db->select('*');
		$this->db->from('_na_countries');
		if($countries_id != null && $countries_id != 0){
			$this->db->where('countries_id', $countries_id);
...
public function update_na_countries($countries_id, $data){
...
public function update_order($countries_id, $order = 1){
		$data['order_by'] = $order;
		$this->db->where('countries_id', $countries_id);
		$this->db->update('_na_countries', $data);
		//Debug($this->db->last_query());
...
public function status_na_countries($countries_id, $enable = 1){
		$data['status'] = $enable;
		$this->db->where('countries_id', $countries_id);
		$this->db->update('_na_countries', $data);
		//echo $this->db->last_query();
...
public function delete_na_countries($countries_id){
		$data = array(
				'status' => 2
		);
		$this->db->where('countries_id', $countries_id);
...
public function delete_na_countries_by_admin($countries_id){
		$this->db->where('countries_id', $countries_id);
