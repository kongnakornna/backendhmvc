...
<?php
	...
	echo form_open('member/save', $attributes);
?>
...
<label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['idcard']?></label>
   <div class="col-sm-9">
	<input type="text" class="col-xs-10 col-sm-2" placeholder="<?php echo $language['idcard']?>" id="idcard" name="idcard">
   </div>
</div>
