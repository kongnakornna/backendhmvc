...
<?php
	...
	echo form_open('status_type/'.$this->uri->segment(3), $attributes);
?>
		...
		<tr>
						...
						<td><span class="col-sm-6">
								...
								<?php
								 ...
								 if($status_type[$key]['status']==1){ ?><font color="#000066"><?php echo $language['enable'];?></font> 
															...
															<div class="hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="#" id="bootbox-confirm<?=$status_type[$key]['status_type_id']?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
