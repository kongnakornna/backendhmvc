												...
												<div class="widget-main">
													<div class="row">
														...
														<?php if($news_list[0]['approve_date'] != ''){?>
															<ul>
																<li>
																<?php if($news_list[0]['approve_date'] != 0) echo RenDateTime($news_list[0]['approve_date'])?>
																</li>
																<li>
...
$( document ).ready(function() {
		console.log( "ready!" );
		<?php if(isset($webtitle)) echo "document.title ='$webtitle';"; ?>
...
?>
				...
				$.ajax({
						...
						success: function(v){
							...
							txt = 'Genarate ID ' + v.body.item[0].news_id + ' ' + v.header.message;
							AlertSuccess(txt);
						},
				});
		});
