...
<?php
	...
	echo form_open_multipart('credit/save', $attributes);
?>
...
?>
		<!-- #section:elements.form -->
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['credit']?>" id="credit_name" name="credit_name">
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
												<label>
													<input name="status" id="credit_status" class="ace ace-switch" type="checkbox" value=1 />
													<span class="lbl"></span>
												</label>
										</div>
								</div>
