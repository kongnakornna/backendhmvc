<!-- ================================================== -->
		<script data-pace-options='{ "restartOnRequestAfter": false }' src="<?php echo base_url('theme');?>/assets/js/plugin/pace/pace.min.js"></script>
		...
		<script data-pace-options='{ "restartOnRequestAfter": true }' src="http://myorange.ca/themes/preview/smartadmin/1.5/phpversion/js/plugin/pace/pace.min.js"></script>
		<!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
		<script src="<?php echo base_url('theme');?>/assets/js/jquery.min.js"></script>
		<script>
			if (!window.jQuery) {
				document.write('<script src="<?php echo base_url('theme');?>/assets/js/libs/jquery-2.1.1.min.js"><\/script>');
			}
		</script>
<!-- ================================================== -->
		<!-- IMPORTANT: APP CONFIG -->
		<script src="<?php echo base_url('theme');?>/assets/js/app.config.js"></script>
		
		<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
		<script src="<?php echo base_url('theme');?>/assets/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js"></script> 
		<!-- BOOTSTRAP JS -->
		...
		<script src="<?php echo base_url('theme');?>/assets/js/plugin/slimscroll/jquery.slimscroll.min.js"></script>
		<!-- Demo purpose only -->
		...
		<script src="<?php echo base_url('theme');?>/assets/js/speech/voicecommand.min.js"></script>		

		<!-- SmartChat UI : plugin -->
		<script src="<?php echo base_url('theme');?>/assets/js/smart-chat-ui/smart.chat.ui.min.js"></script>
		<script src="<?php echo base_url('theme');?>/assets/js/smart-chat-ui/smart.chat.manager.min.js"></script>	

<!--
================================================== 
<script src="<?php echo base_url('theme');?>/assets/js/clearram.js"></script>	
-->