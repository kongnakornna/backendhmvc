...
<?php
	...
	echo form_open_multipart('tags/save', $attributes);
?>
...
?>
		<!-- #section:elements.form -->
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['tags']?>" id="tag_text" name="tag_text">
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
												<label>
													<input name="status" id="tags_status" class="ace ace-switch ace-switch-4" type="checkbox" value=1 <?php if($this->session->userdata('admin_type') > 3) echo 'disabled' ?>/>
													<span class="lbl"></span>
												</label>
										</div>
								</div>
