...
<?php
	...
	echo form_open_multipart('membertype/save', $attributes);
?>
...
?>
		<!-- #section:elements.form -->
								<div class="form-group">
										<label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['type'].$language['member']?></label>
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['type'].$language['member']?>" id="membertype_name" name="membertype_name">
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
												<label>
													<input name="status" type="checkbox" class="ace ace-switch ace-switch-4" id="membertype_status" value=1 checked="checked" />
													<span class="lbl"></span>
												</label>
										</div>
								</div>
