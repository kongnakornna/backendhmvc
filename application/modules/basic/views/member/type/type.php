		...
		<tr>
						...
						<td> 
									...
									<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo site_url('category/add/'.$category[$key]['category_id_map']); ?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo site_url('category/add/'.$category[$key]['category_id_map']); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
