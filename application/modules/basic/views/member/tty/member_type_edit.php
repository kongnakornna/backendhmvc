...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
<input type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $language['status_type']?>" id="status_type_en" name="status_type" value="<?php echo ($cat_arr[0]['lang'] == 'en') ? $cat_arr[0]['status_type_name'] : $cat_arr[1]['status_type_name'] ?>">
										</div>
									</div>
