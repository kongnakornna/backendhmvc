...
?>
<style type="text/css">
	#countitle, #countitle2 {margin-left: 4px; color: rgb(83, 95, 222);"}	
	.reset_article, .sentmail{display:none;}
</style>
							...
							<select class="form-control" id="gender" name="gender">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">												
												<div class="checkbox">
													<label>
														<input type="checkbox" class="ace" name="editor_choice">
														<span class="lbl"> <?php echo $language['use']?></span>
													</label>
												</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">												
												<div class="checkbox">
													<label>
														<input type="checkbox" class="ace" name="recommend">
														<span class="lbl"> <?php echo $language['use']?></span>
													</label>
												</div>
										</div>
...
<?php 
				...
				if($columnist_list)
						for($i = 0; $i < $alllist; $i++){
									...
									echo '<option value="'.$columnist_list[$i]['columnist_id'].'">'.$columnist_name.'</option>';
...
?>
									...
									<div class="form-group" <?php echo $display_en ?>>
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-7 col-sm-10" placeholder="<?php echo $language['title']?>" id="title_en" name="title_en" maxlength="140">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-7 col-sm-10" placeholder="<?php echo $language['title']?>" id="title_th" name="title_th" maxlength="140">
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
												<div id="fullToolbar">
													<textarea  id="embed_script" name="embed_script" style="width:100%;height:150px"></textarea>
												</div>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
													<label>
														<input name="status" id="cat_status" class="ace ace-switch ace-switch-6" type="checkbox" value=0 />
														<span class="lbl"></span>
													</label>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
													<label>
														<input name="can_comment" id="can_comment" class="ace ace-switch ace-switch-6" type="checkbox" value=0 />
														<span class="lbl"></span>
													</label>
										</div>
								</div>
