...
<div class="col-xs-12">
	...
	<span class=""><?php Debug('ภาพข่าว '.$title_article); //if($item_list) echo $caption = $item_list[0]['caption'];?></span>
...
<?php
			...
			if($item_list)
					for($i=0;$i<$allarticle;$i++){
								...
								$picture_id = $item_list[$i]['picture_id'];
								...
								$edit_thumb = base_url('article/picture_edit_thumb/'.$picture_id.'?article_id='.$this->uri->segment(3));
								//$edit_picture = base_url('article/picture_edit/'.$picture_id.'?article_id='.$this->uri->segment(3));
...
?>
										<li>
											...
											<div class="tools tools-top in">
												...
												<a id="bootbox-confirm<?=$picture_id?>" href="javascript:void(0);<?php //$pic_del?>" data-file="<?php echo $file_name?>" data-width="<?php echo $pic_width?>" title="<?php echo $language['delete'].' '.$language['picture']?>" data-rel="tooltip">
