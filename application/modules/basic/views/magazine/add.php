...
<div class="row">
		<div class="col-xs-12">
				...
				<div class="row">
<?php
	$attributes = array('class' => 'form-horizontal', 'name' => 'magazineForm', 'onsubmit' => 'chkform();return false;');
...
<?php
			...
			echo '<input type="hidden" name="magazine_id" value=0>';
?>
...
?>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
													<label>
														<input name="status" id="magazine_status" class="ace ace-switch ace-switch-6" type="checkbox" value=1 />
														<span class="lbl"></span>
													</label>
												</div>
										</div>
