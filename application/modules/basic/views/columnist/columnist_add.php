...
<?php
			...
			//echo '<input type="hidden" name="columnist_id" value=0>';
?>

									<div class="form-group">
										<label for="form-field-1" class="col-sm-3 control-label no-padding-right"><?php echo $language['columnist']?> </label>
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-6" placeholder="<?php echo $language['columnist']?>" id="columnist_name" name="columnist_name">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-6" placeholder="<?php echo $language['full_name']?>" id="full_name" name="full_name">
										</div>
									</div>
								...
								<div class="form-group">
										...
										<div class="col-xs-3">
													<label>
														<input name="status" id="column_status" class="ace ace-switch" type="checkbox" value=1 />
														<span class="lbl"></span>
													</label>
												</div>
										</div>
