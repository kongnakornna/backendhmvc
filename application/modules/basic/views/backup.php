...
<style type="text/css">
.h_title{
background: url(<?php echo base_url();?>images/backupdb/bg_box_head.jpg) repeat-x;
color: #bebebe;
cursor: pointer;
font-size: 14px;
font-weight: normal;
...
background-image: url(<?php echo base_url();?>images/backupdb/error.png);
border-color: #ce9e9e;
}

.success {
background-color: #e8f5df;
background-image: url(<?php echo base_url();?>images/backupdb/success.png);
border-color: #9ece9e;
}
</style>
</head>
