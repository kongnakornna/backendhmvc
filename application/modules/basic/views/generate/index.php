						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<?php $gen_url = base_url('json/nav'); ?>
									<div class="col-sm-6">
										<div class="widget-box widget-color-blue2">
											<div class="widget-header">
												<h4 class="widget-title lighter smaller">Navigation</h4>
												<!-- <a href="<?php //echo $gen_url ?>"> -->
												<span class="btn btn-success tooltip-success" style="float:right" data-rel="tooltip" title="" data-original-title="Generate" data-placement="top">Generate</span>
												<!-- </a> -->
											</div>
									...
									<div class="col-sm-6">
										<div class="widget-box widget-color-blue2">
											<div class="widget-header">
												<h4 class="widget-title lighter smaller"><?php echo $language['highlight'] ?></h4>
												<a href="<?php echo $gen_url ?>">
												<span class="btn btn-success tooltip-success" style="float:right" data-rel="tooltip" title="" data-original-title="Generate" data-placement="top">Generate</span>
												</a>
											</div>
