											...
											<table width="100%" class="table table-striped table-bordered table-hover" id="sample-table-2">
												<thead>
													<tr>
														...
														<th width="5%" class="hidden-480"><?php echo $language['moo'] ?></th>
														<th width="13%" class="hidden-480"><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i><?php echo $language['district'] ?> /<?php echo $language['postcode'] ?>  </th>
														<th width="15%"><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i><?php echo $language['amphur'] ?></th>
														<th width="14%"> <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i> <?php echo $language['province'] ?> </th>
														<th width="8%"> <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i> <?php echo $language['geography'] ?> </th>
														<th width="14%"> <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i> <?php echo $language['countries'] ?> </th>
														<th width="11%"><?php echo $language['action'] ?></th>
													</tr>
												</thead>
...
?>
		<tr>
						...
						<td><?php   echo $district; 
									$vamphur_id=$village[$key]['distrct_id']; 
						...
						<td> 
															...
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo site_url('village/edit/'.$village_id_map.$vurl); ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>

																<a class="red del-confirm" href="#" id="bootbox-confirm<?=$village[$key]['village_id_map']?>" data-value="<?=$village[$key]['village_id_map']?>" data-name="<?=$village[$key]['village_name']?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="<?php echo site_url('village/add/'.$village_id_map.$vurl); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																					<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>																				</span>																			</a>																		</li>

																		<li>
																			<a href="#" id="bx-confirm<?=$village[$key]['village_id_map']?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
