...
/* hw1 stats chart */
				if ($("#hw1-stats").length) {
					...
					var sensor1 = [[1, 75],[2, 45], [3, 87], [4, 93], [5, 127], [6, 116], [7, 137], [8, 135], [9, 130], [10, 167], [11, 169], [12, 179], [13, 185], [14, 176], [15, 180], [16, 174], [17, 193], [18, 186], [19, 177], [20, 153]];
					var sensor2 = [[1, 65],[2, 25], [3, 50], [4, 73], [5, 100], [6, 95], [7, 103], [8, 111], [9, 97], [10, 125], [11, 100], [12, 95], [13, 141], [14, 126], [15, 131], [16, 146], [17, 158], [18, 160], [19, 151], [20, 125], [21, 110], [22, 100], [23, 85], [24, 37]];
					var sensor3 = [[6, 16], [7, 37], [8, 35], [9, 30], [10, 17], [11, 69], [12, 79], [13, 85], [14, 76], [15, 80], [16, 74], [17, 93], [18, 86], [19, 77], [20, 53], [21, 49], [22, 30], [23, 10], [24, 52]];
					var sensor4 = [[1, -5],[2, 15], [3, 20], [4, -3], [5, 60], [6, 75], [7, 10], [8, 11], [9, 67], [10, 25], [11, 10], [12, 55], [13, 41], [14, 76], [15, 31], [16, 46], [17, 58], [18, 60], [19, 51], [20, 25], [21, 10], [22, 10], [23, 45], [24, 32]];
					//console.log(sensor1)
					var plot = $.plot($("#hw1-stats"), [{
						data : sensor1,
						label : "HW1 sensor1"
					}, {
						data : sensor2,
...
$.ajax({
    ...
    success: function(string) {
		...
		<?php $url=base_url();?>
    url: '<?php echo $url;?>apihw/dcodesensor_chart'
});
 
					var sensor1 = <?php $url=base_url();
...
?>;
					var sensor2 = <?php $url=base_url();
			$json_string=$url.'/api/json/HW2_sensor2_hour_chart.json';
			$jsondata=file_get_contents($json_string);
			$data_ret=json_decode($jsondata,true);
			$count=count($data_ret);
			$arr =$data_ret;
...
?>;
					var sensor3 = <?php $url=base_url();
			$json_string=$url.'/api/json/HW2_sensor3_hour_chart.json';
			$jsondata=file_get_contents($json_string);
			$data_ret=json_decode($jsondata,true);
			$count=count($data_ret);
			$arr =$data_ret;
...
?>;
					var sensor4 = <?php $url=base_url();
			$json_string=$url.'/api/json/HW2_sensor4_hour_chart.json';
			$jsondata=file_get_contents($json_string);
			$data_ret=json_decode($jsondata,true);
			$count=count($data_ret);
			$arr =$data_ret;
