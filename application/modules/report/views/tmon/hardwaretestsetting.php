...
<div class="col-xs-12"> 
								...
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('hardwaretestsetting/add') ?>';">
...
<?php
	...
	echo form_open('hardwaretestsetting', $attributes);
?>
													...
													<div class="btn-group">
														...
														<?php if($hardware_list[$key]['status'] == 1 || $hardware_list[$key]['status'] == 0){?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('hardwaretestsetting/edit/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
