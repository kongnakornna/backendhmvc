...
<div class="col-xs-12"> 
								<!-- PAGE CONTENT BEGINS -->
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('smsseting/add') ?>';">
...
<?php
	...
	echo form_open('smsseting', $attributes);
?>
													...
													<div class="btn-group">
														...
														<?php if($smsseting_list[$key]['status'] == 1){?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('smsseting/edit/'.$smsseting_list[$key]['sms_id_map']); ?>">
