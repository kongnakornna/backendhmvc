...
<div class="col-xs-12"> 
								<!-- PAGE CONTENT BEGINS -->
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('electricitytype') ?>';">
								<i class="clip-cog-2"></i> <?php echo $language['electricitytype'] ?> 
								</button>
								
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('waterpipe') ?>';">
								<i class="clip-cog-2"></i> <?php echo $language['waterpipe'] ?> 
								</button>
								
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('hardwaretest/add') ?>';">
...
<a href="<?php echo site_url('hardwaretest/hardwaretest_run/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
<?php  $test=$language['test']; echo "<font color='Green'> $test </font>  "; ?></a>
|<a href="<?php echo site_url('hardwaretest/hardwaretest_log/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
<?php  $view=$language['view'];  echo "<font color='Green'> $view </font>  "; ?>	
</a>
|<a href="<?php echo site_url('hardwaretest/hardwaretest_chart/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
													...
													<div class="btn-group">
														...
														<?php if($hardware_list[$key]['status'] == 1 || $hardware_list[$key]['status'] == 0){?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('hardwaretest/edit/'.$hardware_list[$key]['hardwaretest_id_map']); ?>">
