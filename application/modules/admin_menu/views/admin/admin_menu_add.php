...
<?php
		...
		echo form_open('admin_menu/save', $attributes);
?>
										...
										<?php
												...
												if($parent){
														for($i=0;$i<count($parent);$i++){
																...
																if($parent[$i]['admin_menu_id2'] == $mainmenu)
...
<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="col-xs-10 col-sm-5" placeholder="Icon" id="icon" name="icon" value="<?php echo 'fa-android'; ?>">
										</div>
									</div>
								...
								<input type="hidden" name="admin_menu_id" value="0">
