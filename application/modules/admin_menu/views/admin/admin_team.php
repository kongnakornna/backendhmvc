...
<div class="col-xs-12"> 
								...
								<button class="btn btn-sm btn-primary" onclick="window.location='<?php echo site_url('team/add') ?>';">
										...
										<i class="clip-cog-2"></i>
										<?php echo $language['add'] ?> <?php echo ' '; ?><?php echo $language['admin_team'] ?> 
										<i class="clip-user-plus align-top bigger-125"></i>  
								</button>
...
<?php
	...
	echo form_open('team', $attributes);
?>
...
<div>
	...
	<thead>
		<tr>
														<th width="4%"class="hidden-480"><i class="ace-icon fa fa-cog bigger-110 hidden-480"></i></th>
														<th width="4%"><i class="ace-icon fa fa-sort-numeric-desc bigger-110 hidden-480"></i>
														<?php //echo $language['no'] ?></th>
														<th width="32%"><i class="ace-icon fa fa-sort-amount-desc bigger-110 hidden-480"></i>
														<?php echo $language['title'] ?></th>
														<th width="20%"class="hidden-480">
														<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
														<?php echo $language['create_date'] ?></th>
														<th width="20%"><i class="ace-icon fa fa-sitemap bigger-110 hidden-480"></i>
														<?php echo $language['access'] ?> <?php echo $language['category'] ?></th>
														<th width="10%"class="hidden-480"><i class="ace-icon fa fa-eye bigger-110 hidden-480"></i>
...
?>
		<tr>
						...
						<?=$admin_team[$key]['admin_team_id']?><input type="hidden" class="ace" name="selectid[]" value="<?=$admin_team[$key]['admin_team_id']?>"/>
						</span>
						</td>
						<td><span class="badge badge-warning"> <?=$i?> </span> </td>
						<td><?php if($admin_team[$key]['status'] == 1){?><a href="<?php echo site_url('team/access/'.$admin_team[$key]['admin_team_id']); ?>"title="<?php echo $language['access']?>"><?=$admin_team[$key]['admin_team_title']?></a><?php }else{?> <?php $admin_team_title=$admin_team[$key]['admin_team_title']; echo "<font color='red'> $admin_team_title </font>";?><?php }?></td>
						<td class="hidden-480">
						
						<?php if($admin_team[$key]['status'] == 0){?>
						<?php 
						$create_date=$admin_team[$key]['create_date'];
						if($lang=='th'){$create_date=RenDateTime($create_date); echo "<font color='red'> $create_date </font>";}else{echo "<font color='red'> $create_date </font>";} 
						?>
						 
						<?php }else{?>
		 
						<a href="<?php echo site_url('team/access/'.$admin_team[$key]['admin_team_id']); ?>"title="<?php echo $language['access']; ?>"> 
						<?php 
						$create_date=$admin_team[$key]['create_date'];
						...
						<?php if($admin_team[$key]['status'] == 0){?>
						<?php $access=$language['access']; echo "<font color='red'> $access </font>";?>
						</i>
						</a>
						<?php }else{?>
					<a href="<?php echo site_url('team/access/'.$admin_team[$key]['admin_team_id']); ?>"title="<?php echo $language['access']?>"><?=$language['access'] ?>
					</i></a>
						<?php }?>
						</td>
						<td class="hidden-480">
								<label> 
										<input name="status[]" id="status<?=$admin_team[$key]['admin_team_id']?>" class="ace ace-switch ace-switch-5 btn-empty" type="checkbox" <?php if($admin_team[$key]['status'] == 1) echo 'checked';?>  value=1>
										<span class="lbl"></span>
								</label>
						</td>
						<td class="center">
						<?php #########################?>		
												<div>
													<div class="btn-group">
														...
														<?php if($admin_team[$key]['status'] == 1){?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="<?php echo site_url('team/edit/'.$admin_team[$key]['admin_team_id']); ?>">
																	<i class="fa fa-edit"></i> <?php $edit=$language['edit']; echo "<b><font color='blue'> $edit </font></b>";?>
																</a>
															</li>
														 <?php }if($admin_team[$key]['status'] == 0){#########################?>
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="#"id="bx-confirm<?=$admin_team[$key]['admin_team_id']?>" class="tooltip-error" data-rel="tooltip" title="Delete">
