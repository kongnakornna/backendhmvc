		...
		if($picture_list)
			for($i=0;$i<=count($picture_list);$i++){
					...
					if($folder != '' && $file_name != ''){
							...
							if(file_exists('uploads/thumb/'.$folder.'/'.$file_name)) @unlink('uploads/thumb/'.$folder.'/'.$file_name);
							if(file_exists('uploads/thumb2/'.$folder.'/'.$file_name)) @unlink('uploads/thumb2/'.$folder.'/'.$file_name);
							if(file_exists('uploads/thumb3/'.$folder.'/'.$file_name)) @unlink('uploads/thumb3/'.$folder.'/'.$file_name);
							if(file_exists('uploads/menu/'.$folder.'/'.$file_name)) @unlink('uploads/menu/'.$folder.'/'.$file_name);
