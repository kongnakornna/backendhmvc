...
class getrelatev2 extends REST_Controller {
	...
	public function learning_get() {
		...
		$json['header']['title'] = 'getRelate Version 2.0 Learning';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
		
		$this->load->model('getrelatev2_model');
        $qResult = $this->getrelatev2_model->get_Learning_list($req);
        $json['data'] = $qResult;
	...
	public function learningdetail_get($mul_content_id = 0){
		...
		$this->load->model('getrelatev2_model');
        $qResult = $this->getrelatev2_model->get_Learning_detail($mul_content_id);
        $json['data'] = $qResult;
    ...
    public function getdetailcontent_get($content_id = null) {
        $json = null;
        $this->load->model('getrelatev2_model');
        $qResult = $this->getrelatev2_model->getDetail_content($content_id, 'mul_content');
        //var_dump($qResult);
    ...
    public function knowledgesource_get($content_id = null) {
        ...
        $offset = null;
        $orderby = null;
        $qResult = $this->getrelatev2_model->getRelate_source($content_id, $limit, $offset, $orderby);
        //var_dump($qResult);

        $json['header']['title'] = 'getRelate Version 2.0 Content';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
    ...
    public function knowledgecontent_get($content_id = null, $limit = 20, $order = "random") {
        ...
        if ($subject_id >= 1000 && $subject_id < 9000) {
            $qResult = $this->getrelatev2_model->getRelate_content($content_id, $limit, $offset, $order, $subject_id, $level_id, $context_id);
        } else {
            ...
            $sql = $this->getrelatev2_model->_getContent_query_lite('all', $req);
            //_pr($sql);
    ...
    public function cms_get($content_id = null, $limit = 50, $order = 'random') {
        ...
        $json['header']['title'] = 'getRelate Version 2.0 CMS';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
    ...
    public function admissionnews_get($content_id = null, $limit = 50, $order = 'random') {
        ...
        //$offset = null;
        //$orderby = null;
        $qResult = $this->getrelatev2_model->getRelate_admissionNews($content_id, $limit, $offset, $order, $f, $q, $arrFilter);
        //var_dump($qResult);

        $json['header']['title'] = 'getRelate Version 2.0 AdmissionNews';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
    ...
    public function exam_get($content_id = null, $limit = 20, $order = "random") {
        ...
        $qResult = $this->getrelatev2_model->getRelate_exam($content_id, $limit, $offset, $order, $subject_id, $level_id, $context_id);
        //var_dump($qResult);

        $json['header']['title'] = 'getRelate Version 2.0 Examination';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
    ...
    public function tvprogram_get($content_id = null, $limit = 50, $order = "random") {
        ...
        //$offset = null;
        //$orderby = null;
        $qResult = $this->getrelatev2_model->getRelate_tvprogram($content_id, $limit, $offset, $order, $l1, $l2,$q);
        //var_dump($qResult);

        $json['header']['title'] = 'getRelate Version 2.0 TV Program';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
    ...
    public function tvprogramepisode_get($content_id = null, $limit = 50, $order = "random") {
        ...
        //$offset = null;
        //$orderby = null;
        $qResult = $this->getrelatev2_model->getRelate_tvprogram_episode($content_id, $limit, $offset, $order, $l1, $l2);
        //var_dump($qResult);
    ...
    public function knowledgeupsale_get($content_id = null, $limit = 50, $order = "random") {
        ...
        $contentResult = $this->getrelatev2_model->getDetail_content($content_id, "mul_content");
        ...
        if (is_array($contentResult)) {
            foreach ($contentResult as $key => $v) {
                ...
                $result1 = $this->getrelatev2_model->getRelate_content(null, 5, null, $order, $subject_id, $level_id, $context_id, $filter);
                if (empty($result1)) {
                    $result1 = $this->getrelatev2_model->getRelate_content(null, 5, null, $order, null, $level_id, null, $filter);
                }
                if (empty($result1)) {
                    $result1 = $this->getrelatev2_model->getRelate_content(null, 5, null, $order, $subject_id, null, null, $filter);
                }

                $result2 = $this->getrelatev2_model->getRelate_tvprogram(null, 5, null, $order, $l1 = 1, $l2);
            }
        }
        if (empty($result1)) {
            $result1 = $this->getrelatev2_model->getRelate_content(null, 5, null, 'last', null, null, null);
        }
    ...
    public function knowledgecrosssale_get($content_id = null, $limit = 50, $order = "random") {
        ...
        if (is_array($contentResult)) {
            foreach ($contentResult as $key => $v) {
                ...
                $result1 = $this->getrelatev2_model->getRelate_content(null, 3, null, $order, $subject_id = null, $level_id, $context_id = null, $filter);
                $result2 = $this->getrelatev2_model->getRelate_content(null, 2, null, $order, $subject_id, $level_id = null, $context_id = null, $filter);
                $result3 = $this->getrelatev2_model->getRelate_tvprogram(null, 1, null, $order, $l1 = 1, $l2);
                $result4 = $this->getrelatev2_model->getRelate_tvprogram(null, 2, null, $order, $l1 = 2, $l2);
                $result5 = $this->getrelatev2_model->getRelate_tvprogram(null, 1, null, $order, $l1 = 3, $l2);
            }
        }
    ...
    public function newscamp_get($content_id = null, $limit = 50, $order = 'random') {
        ...
        //$offset = null;
        //$orderby = null;
        $qResult = $this->getrelatev2_model->getRelate_ams_newscamp($content_id, $limit, $offset, $order, $arrFilter);
        //var_dump($qResult);

        $json['header']['title'] = 'getRelate Version 2.0 NewsCamp';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
	...
	public function lessonplan_get($content_id = null) {
        ...
        $qResult = $this->getrelatev2_model->getRelate_lessonplan($content_id, $limit, $offset, $order, $arrFilter);
        //var_dump($qResult);		

        $json['header']['title'] = 'getRelate Version 2.0 LessonPlan';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
	...
	public function lessonplandetail_get($content_id = null) {
		...
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->getRelate_lessonplan_detail($content_id);
		
		$json['header']['title'] = 'getRelate Version 2.0 LessonPlan Detail';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
	...
	public function cmsblog_get($content_id = null) {
        ...
        $qResult = $this->getrelatev2_model->get_cmsblogList($limit, $offset, $order, $arrFilter);
        //var_dump($qResult);		

        $json['header']['title'] = 'getRelate Version 2.0 CMS Blog';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
	...
	public function cmsblogdetail_get() {
		...
		if($content_id==Null){ 
            $json['header']['title'] = 'getRelate Version 2.0 CMS Blog Detail';
        	$json['header']['status'] = '200';
		...
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->getDetail_cmsblog($content_id);
		$json['header']['title'] = 'getRelate Version 2.0 CMS Blog Detail';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
	...
	public function cmsblogdetailrelate_get($content_id = null) {
        ...
        $json['header']['description'] = 'ok';
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->getRelate_cmsblog_forDetail($content_id);
        $json['data'] = $qResult;
        $this->response($json);
	}
	public function cmsblogcategory_get() {
        ...
        $json['header']['description'] = 'ok';
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->get_cmsblogCategoryInfo($cat);
        $json['data'] = $qResult;
        $this->response($json);
	}
	public function cmsblogcategorycode_get($cmsblog_id=null , $category_id = null) {
        ...
        $json['header']['description'] = 'ok';
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->get_cmsblogCategoryCode($cmsblog_id, $category_id);
        $json['data'] = $qResult;
        $this->response($json);
	}
	public function cmsblogcountcontent_get($category_id = null,$zone_id=1) {
		...
		$json['header']['title'] = 'getRelate Version 2.0 CMS Blog Count';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
		$this->load->model('getrelatev2_model');
		...
		$qResult = $this->getrelatev2_model->get_cmsblogCountContent($filter);
        $json['data'] = $qResult;
        $this->response($json);
	}
	...
	public function cmsbloghistory_get($dateNo=null,$monthNo=null,$yearNo=null) {
		...
		$json['header']['title'] = 'getRelate Version 2.0 CMS Blog History';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->get_cmsblog_history($dateNo, $monthNo, $yearNo, $arrFilter);
        //var_dump($qResult);
        $json['data'] = $qResult;
        $this->response($json);
	}
	public function cmsblogfuture_get($dateNo=null,$monthNo=null,$yearNo=null) {
		...
		$json['header']['title'] = 'getRelate Version 2.0 CMS Blog Future';
        $json['header']['status'] = '200';
        $json['header']['description'] = 'ok';
		$this->load->model('getrelatev2_model');
		$qResult = $this->getrelatev2_model->get_cmsblog_future($dateNo, $monthNo, $yearNo, $arrFilter);
        //var_dump($qResult);
        $json['data'] = $qResult;
        $this->response($json);
	}
	...
	public function bloggersummary_get($sumType = 'daily' ,$zone_id = 1, $category_id = null) {
		...
		$filter['zone_id'] = $zone_id;
		$filter['menu'] = $category_id;
		$qResult = $this->getrelatev2_model->get_blogger_summary($filter);
        $json['data'] = $qResult;
        $this->response($json);
	}
}
