...
class Scaptcha
{
	...
	public function main($config = array()) {
		...
		$captcha_config = array(
			...
			'min_length' =>5,
			'max_length' => 5,
			'png_backgrounds' => array(base_url('assets/captcha/scaptcha_bg.png')),
			'fonts' => array(FCPATH.'assets\scaptcha\times_new_yorker.ttf'),
		...
		// Generate image src
		$image_src = site_url('kaiwaisai/viewcaptcha').'?t=' . urlencode(microtime());
