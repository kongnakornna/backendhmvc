...
Class Facebook
{
    ...
    {
        // Load config
        //$this->load->config('facebook26');

		$config['facebook_app_id']            = '704799662982418';
		$config['facebook_app_secret']        = '3e8e7e8650c369085e9da98306b8b4ee';
		$config['facebook_login_type']          = 'web';
		$config['facebook_login_redirect_url']  = 'http://www.trueplookpanya.com/login'; //login
		$config['facebook_logout_redirect_url'] = 'http://www.trueplookpanya.com/logout'; //logout
        ...
        {
            $this->fb = new FB([
                'app_id'                => '704799662982418', //$this->config->item('facebook_app_id'),
                'app_secret'            => '3e8e7e8650c369085e9da98306b8b4ee', //$this->config->item('facebook_app_secret'),
                'default_graph_version' => 'v2.6', //$this->config->item('facebook_graph_version')
            ]);
        }
