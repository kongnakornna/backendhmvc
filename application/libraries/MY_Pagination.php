...
class MY_Pagination extends CI_Pagination {
    ...
    var $first_tag_open     = '<span class="bold">';
    var $first_tag_close    = '</span>';
    var $first_link         = '<<';
    var $last_tag_open      = '<span class="bold">';
    var $last_tag_close     = '</span>';
    var $last_link          = '>>';
    var $next_tag_open      = '<span class="bold">';
    var $next_tag_close     = '</span>';
    var $next_link          = '>';
    var $prev_tag_open      = '<span class="bold">';
...
//        echo "-1->".$num_pages;
        ...
        if ($CI->config->item('enable_query_strings') === TRUE OR $this->page_query_string === TRUE) {
            ...
            // $uri_page_number = ltrim($uri_page_number, urldecode($this->suffix));
            // $uri_page_number = rtrim($uri_page_number, urldecode($this->suffix));
