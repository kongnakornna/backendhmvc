...
class Simpleimage {
    ...
    function resize_crop($max_width, $max_height, $quality = 80) {
...
//            imagefilledrectangle($new, 0, 0, $width_new, $height_new, $transparent);
            //------
            //cut point by height
            $h_point = (($height - $height_new) / 2);
            //copy image
            imagecopyresampled($new, $this->image, 0, 0, 0, $h_point, $max_width, $max_height, $width, $height_new);
        } else {
            //cut point by width
            $w_point = (($width - $width_new) / 2);
            imagecopyresampled($new, $this->image, 0, 0, $w_point, 0, $max_width, $max_height, $width_new, $height);
        }
