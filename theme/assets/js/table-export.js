var TableExport = function() {
	...
	var runDataTable_example2 = function() {
		...
		var oTable = $('#sample-table-2').dataTable({
			...
			"aaSorting" : [[0, 'asc']],
			"aLengthMenu" : [[5, 10, 15, 20,50,100, -1], [5, 10, 15, 20,50,100, "All"] // change per page values here
			],
			// set the initial value
			"iDisplayLength" : 50,
		});
		$('#sample-table-2_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search/ค้นหา");
