...
CKEDITOR.plugins.setLang( 'image2', 'th', {
	...
	captioned: 'ใส่ Caption', // MISSING
	captionPlaceholder: 'ภาพจาก', // MISSING
  ...
  responsiveSize: 'ปรับขนาดอัตโนมัติ',
	resizer: 'Click and drag to resize', // MISSING
	title: 'คุณสมบัติของ รูปภาพ',
	uploadTab: 'อัพโหลดไฟล์',
	urlMissing: 'Image source URL is missing.', // MISSING
  captionMissing: 'โปรดใส่ที่มาของภาพ.', // MISSING
  captionPlaceholderLink: 'ที่มาของภาพ URL',
  captionPlaceholderText: 'ที่มาของภาพ Text (Required)',
} );
