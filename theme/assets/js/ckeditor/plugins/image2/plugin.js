...
( function() {
	...
	CKEDITOR.plugins.add( 'image2', {
      ...
      // Has Captioned
      config.requireHasCaption=config.image2_requireCaption ? config.image2_requireCaption : false;
	...
	function widgetDef( editor ) {
        ...
        if ( this.data.captionText && !editor.filter.checkFeature( features.captionText ) )
					this.data.captionText = editor.lang.image2.captionPlaceholder;
			...
			init: function() {
				var helpers = CKEDITOR.plugins.image2,
					...
					data = {
            captionText: !!this.parts.captionText,
            captionLink: !!this.parts.captionLink,
	...
	CKEDITOR.plugins.image2 = {
		stateShifter: function( editor ) {
            ...
            /* EDIT BY OATIZ :: แก้ตัว Link ใต้ภาพ*/
            var customCaptionPlaceholder = editor.lang.image2.captionPlaceholder;
            if(shift.newData.captionLink != '' && shift.newData.captionText != ''){
              customCaptionPlaceholder= '<a href="'+shift.newData.captionLink+'" target="_blank">'+shift.newData.captionText+'</a>';
            }else if(shift.newData.captionText != ''){
              customCaptionPlaceholder=shift.newData.captionText;
            }
            /* EDIT BY OATIZ :: */
            
						var figure = CKEDITOR.dom.element.createFromHtml( templateBlock.output( {
							captionedClass: captionedClass,
							captionPlaceholder: customCaptionPlaceholder
						} ), doc );
	...
	function getWidgetFeatures( editor ) {
		var alignClasses = editor.config.image2_alignClasses,
			features = {
				dimension: {
					requiredContent: 'img[width,height,class]'
				},
				align: {
					requiredContent: 'img' +
