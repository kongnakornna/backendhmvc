...
function LayoutBuilder() {
        ...
        '<div class="container-fluid layout-container">' +
          '<div class="row layout-row" >' +
            '<div class="col-xs-{size1} col-sm-{size1} col-md-{size1} col-lg-{size1} layout-column">' +
              '<div class="layout-column-one layout-column-editable"><p><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/><br/> </p></div>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>'));
  defaultLayoutTemplates.push(new CKEDITOR.template(
      '<div class="layoutmanager">' +
        '<div class="container-fluid layout-container">' +
          '<div class="row layout-row">' +
            '<div class="col-xs-12 col-sm-6 col-md-{size1} col-lg-{size1} layout-column ">' +
              '<div class="layout-column-one layout-column-editable"><p><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/><br/> </p></div>' +
            '</div>' +
            '<div class="col-xs-12 col-sm-6 col-md-{size2} col-lg-{size2} layout-column">' +
              '<div class="layout-column-two layout-column-editable"><p><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/><br/> </p></div>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>'));
  defaultLayoutTemplates.push(new CKEDITOR.template(
      '<div class="layoutmanager">' +
        '<div class="container-fluid layout-container">' +
          '<div class="row layout-row">' +
            '<div class="col-xs-12 col-sm-{size1} col-md-{size1} col-lg-{size1} layout-column">' +
              '<div class="layout-column-one layout-column-editable"><p><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/><br/> </p></div>' +
            '</div>' +
            '<div class="col-xs-12 col-sm-{size2} col-md-{size2} col-lg-{size2} layout-column">' +
              '<div class="layout-column-two layout-column-editable"><p><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/><br/> </p></div>' +
            '</div>' +
            '<div class="col-xs-12 col-sm-{size3} col-md-{size3} col-lg-{size3} layout-column">' +
              '<div class="layout-column-three layout-column-editable"><p><img src="http://placehold.it/400x225&text=Image" class="img-responsive"/> </p></div>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>'));
