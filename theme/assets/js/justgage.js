 ...
 * -----------------------------
 ...
 JustGage = function(config) {
  ...
  obj.config =
  {
    ...
    titleFontColor : obj.kvLookup('titleFontColor', config, dataset,  "#6f7b8a"),
    ...
    valueFontColor : obj.kvLookup('valueFontColor', config, dataset, "#6f7b8a"),
    ...
    gaugeColor : obj.kvLookup('gaugeColor', config, dataset, "#f1f3f5"),
    ...
    labelFontColor : obj.kvLookup('labelFontColor', config, dataset, "#6f7b8a"),
