...
var Application = function() {
  ...
  this.adTagUrl_ = 'http://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/4891037/DevilVideo&ciu_szs'+
  '&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]&description_url=[description_url]&correlator=[timestamp]';
  this.adTagOverlayUrl_ = "http://pubads.g.doubleclick.net/gampad/ads?sz=460x60&iu=/4891037/Overlay-ad&ciu_szs"+
          "&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]";
